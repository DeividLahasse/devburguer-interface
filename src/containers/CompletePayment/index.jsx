...
const ERROR_STATUSES = ['requires_payment_method', 'default'];
...
function CompletePage() {
  ...
  return (
    <PaymentStatus>
      <StatusIcon color={statusContent.iconColor}>
        {statusContent.icon}
      </StatusIcon>
      <StatusText>{statusContent.text}</StatusText>
      {intentId && (
        <DetailsTable>
          <table>
            <tbody>
      ...
      {/* ✅ Botão aparece apenas em caso de erro */}
      {isError && (
        <RetryButton href={statusContent.url}>
          {statusContent.buttonText}
        </RetryButton>
      )}

      {/* ✅ Botão aparece apenas quando o pagamento foi bem-sucedido */}
      {isSuccess && (
        <RetryButton href={statusContent.url}>
          {statusContent.buttonText}
        </RetryButton>
...
export function CompletePayment() {
  ...
  if (!clientSecret) {
    return <div>{STATUS_CONTENT_MAP.default.text}</div>;
  }
